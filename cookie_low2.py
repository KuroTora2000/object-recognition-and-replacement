            ...
            if args.display_text:
                ...
                #setting xRotation and yRotation
                    ...
                    if(roundness<0.94 and (degree<3 ) ):
                        img=cv2.imread('cookie_low2_horizontal.png' ,cv2.IMREAD_UNCHANGED)
                        w = x2-x1
                        h = y2-y1
                    #dim = (width, height)
                        ...
                        img=cv2.imread('cookie_low2_vertical.png' ,cv2.IMREAD_UNCHANGED)
                        w = x2-x1
                        h = y2-y1
                    #dim = (width, height)
                        img = cv2.resize(img, dsize=(w, h))
                        ...
                        img=cv2.imread('cookie_low2_45.png' ,cv2.IMREAD_UNCHANGED)
                        w = x2-x1
                        h = y2-y1
                    #dim = (width, height)
                        img = cv2.resize(img, dsize=(w, h))
                        ...
                        img=cv2.imread('cookie_low2_135.png' ,cv2.IMREAD_UNCHANGED)
                        w = x2-x1
                        h = y2-y1
                    #dim = (width, height)
                        img = cv2.resize(img, dsize=(w, h))
                        ...
                        img =cv2.imread('cookie_low2.png',cv2.IMREAD_UNCHANGED)
                   # scale_percent = 200 
                        w = x2-x1
                        h = y2-y1
                    #dim = (width, height)
